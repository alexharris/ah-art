  ...
  render () {
    ...
    return (
      <div className="max-w-3xl copy">
       <div className="big-text mb-8">I am an artist and writer in Oakland.<br /> Here is some of my work:</div>
      <Markdown>{`
...
## Illustration
- [Good Eggs zine, spring 2024](/good-eggs-zine)  
- [Bay Nature Mushroom articles](/bay-nature-mushrooms) (I wrote the articles as well)
...
## AHWD
I build and maintain websites, mostly but not exclusively using Wordpress, for a variety of clients  
[See some websites](https://alexharris.online)
