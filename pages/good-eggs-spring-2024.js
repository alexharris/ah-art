  ...
  return (
    <div>
      ...
      <div className="max-w-7xl flex flex-wrap">
        ...
        <img className="w-full md:w-1/2  md:pr-2 pb-2" src="/illustration/good-eggs-spring-24/ghia-web.jpg" alt="Ghia" />
        <img className="w-full md:w-1/2  md:pr-2 pb-2" src="/illustration/good-eggs-spring-24/minor-figures-web.jpg" alt="Minor Figures" />
        <img className="w-full md:w-1/2  md:pr-2 pb-2" src="/illustration/good-eggs-spring-24/model-bakery-web.jpg" alt="Model Bakery English Muffins" />
        <img className="w-full md:w-1/2  md:pr-2 pb-2" src="/illustration/good-eggs-spring-24/post-flirtation-web.jpg" alt="Post Flirtation Wine" />
      ...
      <div className="max-w-7xl flex flex-wrap">
        ...
        <img className="w-full md:w-1/2  md:pr-2 pb-2" src="/illustration/good-eggs-spring-24/inna-pickle.jpg" alt="INNA Pickle"/>
      ...
      <div className="max-w-7xl flex flex-wrap">
        ...
        <img className="w-full md:w-1/2  md:pr-2 pb-2" src="/illustration/good-eggs-spring-24/grapefruit-peeled.jpg" alt="Peeled Grapefruit"/>
        <img className="w-full md:w-1/2  md:pr-2 pb-2" src="/illustration/good-eggs-spring-24/grapefruit-slice-web.jpg" alt="Grapefruit Slice"/>
        <img className="w-full md:w-1/2  md:pr-2 pb-2" src="/illustration/good-eggs-spring-24/grapefruit-slices-web.jpg" alt="Grapefruit Slices"/>
        <img className="w-full md:w-1/2  md:pr-2 pb-2" src="/illustration/good-eggs-spring-24/grapefruit-web.jpg" alt="Grapefruit"/>
        <img className="w-full md:w-1/2  md:pr-2 pb-2" src="/illustration/good-eggs-spring-24/sumo-slices-web.jpg" alt="Sumo Tangerine Slices"/>
        <img className="w-full md:w-1/2  md:pr-2 pb-2" src="/illustration/good-eggs-spring-24/sumo-web.jpg" alt="Sumo Tangerine"/>
      </div>       
    </div>
...
export default goodEggsSpring2024
